  ...
  try {
    ...
    const completion = await openai.createChatCompletion({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Can you make detailed (includes numbers, timeframe, exact user actions, etc.) test case scenarios that test similar functionalities as the test case scenario below?
                  {
                    "Test_Case_Scenarios":
                    [
                      {
    ...
    console.log(
      "Error while generatin similar test cases:",
      JSON.stringify(err)
    );
